...
//    op_loadsym:
    ...
    CASE(OP_JMP, S);
      i = irep - opstart;
      fprintf(fp, "OP_JMP\t%03d", (int)i+(int16_t)a);
      break;
    CASE(OP_JMPUW, S);
      i = irep - opstart;
      fprintf(fp, "OP_JMPUW\t%03d", (int)i+(int16_t)a);
      break;
    CASE(OP_JMPIF, BS);
      i = irep - opstart;
    ...
    CASE(OP_GETIDX, B);
      ...
      break;
    CASE(OP_SETIDX, B);
      fprintf(fp, "OP_SETIDX\tR%d\t(R%d)\t(R%d)", a, a + 1, a + 2);
      break;
    CASE(OP_CALL, Z);
      fprintf(fp, "OP_CALL\n");
      break;
    ...
    CASE(OP_RANGE_EXC, B);
      ...
      break;
    CASE(OP_DEF, BB);
      fprintf(fp, "OP_DEF\tR%d\t:%s", a, pico_mrb_sym_dump(mrb, b));
      break;
    CASE(OP_UNDEF, B);
    ...
    CASE(OP_ALIAS, BB);
      ...
      break;
    CASE(OP_ADD, B);
      fprintf(fp, "OP_ADD\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_ADDI, BB);
      fprintf(fp, "OP_ADDI\tR%d\t%d", a, b);
      break;
    CASE(OP_SUB, B);
      fprintf(fp, "OP_SUB\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_SUBI, BB);
      fprintf(fp, "OP_SUBI\tR%d\t%d", a, b);
      break;
    CASE(OP_MUL, B);
      fprintf(fp, "OP_MUL\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_DIV, B);
      fprintf(fp, "OP_DIV\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_LT, B);
      fprintf(fp, "OP_LT\t\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_LE, B);
      fprintf(fp, "OP_LE\t\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_GT, B);
      fprintf(fp, "OP_GT\t\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_GE, B);
      fprintf(fp, "OP_GE\t\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_EQ, B);
      fprintf(fp, "OP_EQ\t\tR%d\tR%d", a, a+1);
      break;
    CASE(OP_ARRAY, BB);
      fprintf(fp, "OP_ARRAY\tR%d\t(R%d)\t%d\t", a, a, b);
      print_lv_a(mrb, irep, a);
      break;
    CASE(OP_ARRAY2, BBB);
