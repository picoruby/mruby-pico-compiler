...
//        fprintf(fp, "OP_LOADL\tR%ld\tL(%d)\t; %f", a, b, (double)irep->pool[b].u.f);
//#endif
//        break;
//      case IREP_TT_INT32:
//        fprintf(fp, "OP_LOADL\tR%ld\tL(%d)\t; %" PRId32, a, b, irep->pool[b].u.i32);
//        break;
//#ifdef PICORB_64BIT
//      case IREP_TT_INT64:
//        fprintf(fp, "OP_LOADL\tR%ld\tL(%d)\t; %" PRId64, a, b, irep->pool[b].u.i64);
//        break;
//#endif
//      default:
